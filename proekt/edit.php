...
if (empty($_SESSION['user_id'])) {
    header('Location: /drupal/login.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($isAJAX) {
        echo json_encode([
            'success'      => true,
            'redirect_url' => '/drupal/edit.php?success=1',
        ]);
        exit;
    }
    header('Location: /drupal/edit.php?success=1');
    exit;
}
...
<head>
    ...
    <title>Edit</title>
    <script defer src="/drupal/EditForm.js"></script>
